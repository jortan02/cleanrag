...
st.set_page_config(
    page_title="CleanRAG - Results & Visualization", page_icon="📊", layout="wide"
)
...
qa_data = pd.DataFrame(
    {
        ...
        "Category": np.random.choice(
            ["Technical", "General", "Specific", "Complex"], 20
        ),
    }
)
...
analysis_tabs = st.tabs(
    ["Answer Distribution", "Category Performance", "Detailed Results"]
)
...
chunk_usage = pd.DataFrame(
    {
        ...
        "Category": np.random.choice(
            ["Technical", "General", "Specific", "Complex"], 15
        ),
    }
)
